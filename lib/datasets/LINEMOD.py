...
class LINEMOD(imdb):
    ...
    def _load_annotation(self, index):
        ...
        filename = os.path.join(self._data_path, 'train', 'bbox_'+ index + '.txt')
        f = open(filename)
        print "index : ", index
        print filename
...
if __name__ == '__main__':
    ...
    d = LINEMOD('LINEMOD', '/media/chaitanya/DATADRIVE0/datasets/rcnn_training/LINEMOD')
    res = d.roidb
