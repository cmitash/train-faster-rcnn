...
def demo(net):
    ...
    ftest = open(os.path.join('/home/zhusj/Github/py-faster-rcnn/data/APC/Classification/imagelist.txt'),'r')
    outputFile = open(os.path.join('/home/zhusj/Github/py-faster-rcnn/data/APC/Classification/result.txt'),'w')
    number = ftest.readline().strip()

    base_path = '/home/zhusj/Github/py-faster-rcnn/data/APC/Classification/test/'
    bbox_filename = base_path+'bbox_'+number+'.txt'
    while bbox_filename:
        with open(bbox_filename, "r") as filestream:
            print bbox_filename
            im_file = base_path+'image_'+number+'.png' # base_path+'image_'+number+'.png'
            # print im_file
