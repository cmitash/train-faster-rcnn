...
NETS = {'vgg16': ('VGG16',
        ...
        # '674':('674',
        #           'vgg16_faster_rcnn_iter_70000seed_3.caffemodel')}
...
if __name__ == '__main__':
 ...
 #   im_names = ['000456.jpg', '000542.jpg', '001150.jpg',
  ...
  #  plt.show()
    ftest = open('detection_imageList2.txt','r')
    outputFile = open('DetectionResult2.txt','w')
    number = ftest.readline().strip()
    im_name = '/home/zhusj/Github/py-faster-rcnn/data/CS674/Detection/test2/'+'image_'+number+'.png'
